...
export default async function CompanyListPage(props: {
    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-sm leading-7 text-muted">
              Browse and manage all registered partner companies. Search, view, and delete records.
            </p>
          </div>
      ...
      <article className="panel rounded-[30px] p-6 ring-1 ring-slate-200 shadow-[0_24px_60px_-45px_rgba(15,23,42,0.35)]">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <form
            action="/dashboard/companies/list"
